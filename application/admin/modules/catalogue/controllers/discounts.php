...
class Discounts extends AG_Controller {
    ...
    {
        parent::__construct();
        $this->template->add_title("Каталог продукции - ")->add_title("Скидки на покупку - ");
        $this->template->add_navigation("Каталог продукции")->add_navigation("Скидки на покупки", set_url("*/*/"));
    }
    ...
    public function add()
    {
        $this->template->add_title("Добавление скидки");
        $this->template->add_navigation("Добавление скидки");
    ...
    {
        $this->template->add_title("Редактирование скидки");
        $this->template->add_navigation("Редактирование скидки");
