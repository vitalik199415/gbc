...
<ul id="gbc_dropdown_menu">
	...
	<a href="#" style="width:180px;"><p>Каталог продукции</p></a>
			<ul>
				...
				<!--<li><a href="<?=set_url('catalogue_mass_sale')?>"><p>Массовые скидки</p></a></li>-->
				<li>
					<a href="#" class="str"><p>Свойства продуктов</p></a>
						<ul>
							<li>
								<a href="<?=set_url('catalogue/products_properties')?>"><p>Свойства продуктов</p></a>
							</li>
							<li>
								<a href="<?=set_url('catalogue/products_types')?>"><p>Группы свойств продуктов</p></a>
							</li>
						</ul>
				</li>
				<li>
                ...
                <li>
                    <a href="#" class="str"><p>Скидки на покупку</p></a>
                    <ul>
                        <li>
                            <a href="<?=set_url('catalogue/discounts')?>"><p>Скидки на покупку</p></a>
                        </li>
                        <li>
                            <a href="<?=set_url('catalogue/discount_coupons')?>"><p>Купоны на скидку</p></a>
                        </li>
                    </ul>
                </li>
			</ul>
